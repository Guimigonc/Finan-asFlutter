      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                CardOne(color: Colors.green, heading: 'Credito', amount: '${data['creditoTotal']}',),
                SizedBox(
                  width: 10,
                ),
                CardOne(color: Colors.red, heading: 'Debito', amount: '${data['debitoTotal']}',),
